...
const MyEvents = () => {
  ...
  return (
    <>
      ...
      <div className='flex min-h-screen gap-20 bg-zinc-700 pt-8 px-5'>
        <motion.div
        ...
        <div className='max-w-5xl px-4 relative top-24'>
          <div className='flex flex-col lg:flex-row gap-10'>
            <div className='flex-1'>
              <div className='flex flex-col w-full md:flex-row justify-between items-start md:items-center gap-96 mb-8'>
